...
public class Warrior {
    ...
    private int onUpHealth = 30;
    private int onUpstrength = 5;
    private int onUpdexterity = 2;
    private int onUpintelligence = 1;
    ...
    public void attack(){
        ...
        //get the level up values for Warrior
        ...
        //Print the results
        System.out.println("Warrior warrior stats");
        System.out.println("---------------");
